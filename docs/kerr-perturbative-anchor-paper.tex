...
coefficient solve.  The finite-spin search result is negative: 766 candidate
inputs were scanned, 456 targeted finite-spin correction candidates passed the
strict prechecks before the full residual, and zero candidates had exact-zero
...
\begin{tikzpicture}[
  ...
  \node[piece, right=of gate, draw=red, fill=red!6] (out) {0 / 456\\exact-zero residuals};
