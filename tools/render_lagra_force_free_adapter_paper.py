...
<main>
  ...
  <h2>3. Engine discoveries admitted by the measurement</h2>
  <p>
    ...
    determinant instead of trusting the validator cache.  The novelty claim is
    scoped narrowly: these are engine-novel relative to the repository registry,
    not claimed as literature-first discoveries.
  </p>
  <table>
...
python3 experiments/proof-search/proof_search_integrity_gate.py</pre>
  ...
  <p class="claim">
    ...
    now process-clean, and it yields six independently rechecked candidates not
    identical to the registered known-solution functions.  The full reproduction
    boundary remains: the bounded pass only finds two known vertical canonical
    forms and does not recover the seven known Compere solutions.  The bounded
    health gate is included precisely so the paper cannot confuse the new
    candidate artifact with a full reproduction claim.
  </p>
</main>
</body>
</html>
